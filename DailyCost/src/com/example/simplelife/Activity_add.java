...
public class Activity_add extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, R.layout.title_add);//设置自定义标题栏
        AppManager.getAppManager().addActivity(Activity_add.this);//将该Activity实例添加到AppManager的堆栈
	...
	/*----------achieve the date to be edited---------------*/
        ...
        bn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				Intent intent=new Intent(Activity_add.this,Activity_list.class);
				finish();
        ...
        bn2.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				EditText e1=(EditText)findViewById(R.id.breakfast);
				e1.setFocusable(true);//控制键盘是否可以获得这个控件的焦点
				e1.setFocusableInTouchMode(true);//touch模式下获得焦点
				e1.requestFocus();//请求获得焦点，即光标在该输入框闪烁
				EditText e2=(EditText)findViewById(R.id.launch);
