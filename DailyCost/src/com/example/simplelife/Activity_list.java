	...
	/*------------返回原界面--------------*/
		...
		return_start.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent intent=new Intent(Activity_list.this,Activity_start.class);// TODO Auto-generated method stub
   ...
   /*------------进入记账页面----------*/
	...
	public void onResume()
	{
		...
		{   
			...
			if(cursor.getCount()!=0)
			{
			    ...
			    list.setOnItemLongClickListener(new OnItemLongClickListener(){
			    	...
			    	public boolean onItemLongClick(AdapterView<?> parent,View view,int position,long id)
			    	{
			    		...
			    		Intent intent=new Intent(Activity_list.this,Activity_modify.class);
			...
			{
				Toast toast=Toast.makeText(Activity_list.this,"本月还没有记录！", Toast.LENGTH_SHORT);//there is no record in this month
				toast.show();
			}
		}
		else
		{
			Toast toast=Toast.makeText(Activity_list.this,"现在还没有记录，可以开始记录！", Toast.LENGTH_SHORT);
